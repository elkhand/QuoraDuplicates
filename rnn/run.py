...
if __name__ == "__main__":
    ...
    command_parser.add_argument('-v', '--vocab', type=argparse.FileType('r'), default="/Users/kyu/quora/quora-duplicates/rnn/data/glvocab_1_100.txt", help="Path to vocabulary file")
    command_parser.add_argument('-vv', '--vectors', type=argparse.FileType('r'), default="/Users/kyu/quora/quora-duplicates/rnn/data/glwordvectors_1_100.txt", help="Path to word vectors file")
